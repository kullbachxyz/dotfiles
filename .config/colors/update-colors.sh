...
awk '
  ...
  END {
    ...
    print "    --wb-toolbar: " bg ";";
    print "    --wb-toolbar-text: " fg ";";
    print "    --wb-frame: " bg_dark ";";
    print "    --wb-tab-text: " fg ";";
    print "    --wb-tab-line: " accent ";";
    print "    --wb-popup: " bg_dark ";";
    print "    --wb-popup-text: " fg ";";
    print "    --wb-ntp: " bg ";";
    print "    --wb-ntp-text: " fg ";";
    print "    --wb-sidebar: " bg ";";
    print "    --wb-sidebar-text: " fg ";";
    print "    --wb-sidebar-highlight: " border ";";
    print "    --wb-sidebar-highlight-text: " accent ";";
    print "    --wb-toolbar-field: " bg_dark ";";
    print "    --wb-toolbar-field-focus: " fg_gutter ";";
    print "    --wb-toolbar-field-border: " bg_popup ";";
    print "    --wb-toolbar-field-border-focus: " orange ";";
    print "    --wb-toolbar-field-text: " fg ";";
    print "    --wb-toolbar-field-text-focus: " fg ";";
    print "  }";
    print "  #main-window, #titlebar, #TabsToolbar {";
    print "    background-color: var(--wb-frame) !important;";
    print "    color: var(--wb-tab-text) !important;";
    print "  }";
    print "  #navigator-toolbox, #nav-bar {";
    print "    background-color: var(--wb-toolbar) !important;";
    print "    color: var(--wb-toolbar-text) !important;";
    print "  }";
    print "  .tab-background {";
    print "    background-color: var(--wb-frame) !important;";
    print "    border-color: var(--wb-bg-highlight) !important;";
    print "  }";
    ...
    print "  }";
    print "  .tab-line {";
    print "    background-color: var(--wb-tab-line) !important;";
    print "  }";
    print "  .tabbrowser-tab[busy] .tab-loading-burst::before {";
    print "    background-color: var(--wb-tab-line) !important;";
    print "  }";
    ...
    print "  }";
    print "  #sidebar-box, #sidebar-header {";
    print "    background-color: var(--wb-sidebar) !important;";
    print "    color: var(--wb-sidebar-text) !important;";
    print "  }";
    print "  #sidebar-box .sidebar-placesTreechildren {";
    print "    color: var(--wb-sidebar-text) !important;";
    print "  }";
    print "  #sidebar-header, #sidebar-switcher-target {";
    print "    border-color: transparent !important;";
    print "  }";
    print "  #sidebar-box treechildren::-moz-tree-row(selected) {";
    print "    background-color: var(--wb-sidebar-highlight) !important;";
    print "  }";
    print "  #sidebar-box treechildren::-moz-tree-cell-text(selected) {";
    print "    color: var(--wb-sidebar-highlight-text) !important;";
    print "  }";
    print "}";
  }
